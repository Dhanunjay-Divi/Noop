...
| Source redistribution rights | Cleared by the owner-controlled consolidation declaration. Every artifact still requires a passing distribution gate, unchanged NOOP PolyForm license, and complete independent dependency notices. |
