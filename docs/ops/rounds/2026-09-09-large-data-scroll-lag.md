...
- Apple and Android status pulses, band-sync sweeps, and Daily Signal waveform
  ...
  primitives, leaving their steady semantic state visible while scrolling owns
  the frame budget.
...
| Scroll-interaction clock follow-up | Android compiled and ran 22 retained-screen, Health, and frame-pacer contracts with zero failures in 23 seconds; Apple compiled and ran 22 retained-screen, Health, and Liquid Today contracts with zero failures | Connection/status pulses, band-sync sweeps, and Daily Signal waveforms stop their decorative clocks while drag or fling owns the frame budget on both platforms | Physical GPU timing, hidden OS work, or the tester's exact phone |
