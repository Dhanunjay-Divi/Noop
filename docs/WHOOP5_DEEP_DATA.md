...
**Tracking:** [#103](https://github.com/Dhanunjay-Divi/Noop/issues/103) (raw HCI captures + new deep-record layouts).
...
| A community BTSnoop capture ([#103](https://github.com/Dhanunjay-Divi/Noop/issues/103)) | Bluetooth HCI log of the official app on a real strap | Independently surfaced the same `enable_r22_*` console report + the channel layout. |
...
frame-builder; the 16th, `enable_sig12`, was added from a real on-strap HCI capture ([#103](https://github.com/Dhanunjay-Divi/Noop/issues/103))
...
- **It may not even be necessary.** [goose #24](https://github.com/Dhanunjay-Divi/Noop/issues/24) shows a Gen5
...
This is the single most common "is it broken?" report (e.g. [#623](https://github.com/Dhanunjay-Divi/Noop/issues/623)),
...
- **No *confirmed* SpO₂ field on the 5.0 wire — but there is now a candidate.** The raw optical tail
  ...
  ([#103](https://github.com/Dhanunjay-Divi/Noop/issues/103)) reads v18 byte `@82` as a **strap-computed SpO₂ %
...
[#103](https://github.com/Dhanunjay-Divi/Noop/issues/103) without posting their capture or their data export.
...
3. Keep wearing it, let it sync, then **share your strap log** on [#103](https://github.com/Dhanunjay-Divi/Noop/issues/103) — we're looking for new deep
...
4. Even better: a Bluetooth HCI capture of the **official app syncing a full night's history** shows the deep
   ...
   used. Filter to just the WHOOP peripheral and attach it to [#103](https://github.com/Dhanunjay-Divi/Noop/issues/103).

Credit to **judes.club** and **Asherlc/dofek** for published interoperability
facts, with the implementation verified independently in NOOP.
