...
enum PuffinExperiment {
    ...
    /// Retired compatibility key. It is no longer exposed or read by production staging because
    /// historical activity byte @63 also represents wear/contact quality. Kept so existing preferences
    /// and backups remain decodable.
