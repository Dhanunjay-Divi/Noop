    ...
    private var tips: some View {
        StrandCard(padding: 20) {
            VStack(alignment: .leading, spacing: 12) {
                ...
                Text("Buzz Noop Band or mark a moment from Siri, Spotlight, the Shortcuts app, or a Back-Tap automation. No setup needed.")
    ...
    private var shortcutsCard: some View {
        StrandCard(padding: 20) {
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text("Wire NOOP's actions into a Back-Tap, a focus automation, or a longer Shortcut. For example, double-tap the back of your iPhone to buzz Noop Band.")
                    .font(StrandFont.caption)
                    .foregroundStyle(StrandPalette.textTertiary)
                    .fixedSize(horizontal: false, vertical: true)
                ShortcutsLink()
