...
class AnalysisInputGateContractTest {
    ...
    fun launchResumeLoopClaimsBoundedSourcesAndDoesNotScanHistory() {
        ...
        assertTrue(loop.contains("\"outcome\" to \"deferred\""))
        assertTrue(loop.contains("\"reason\" to \"late_evening\""))
    ...
    fun postBackfillPathUsesGenerationGateWithoutLegacyWatermark() {
        ...
        val start = source!!.indexOf("private suspend fun awaitEvaluablePostBackfillAnalysis(")
        ...
        assertTrue(pass.contains("\"outcome\" to \"deferred\""))
        assertTrue(pass.contains("\"reason\" to \"late_evening\""))
        assertTrue(pass.contains("\"scan_days\" to \"0\""))
        assertTrue(pass.contains("delay(waitSeconds * 1_000L)"))
        assertTrue(pass.contains("awaitEvaluablePostBackfillAnalysis(sourceId) ?: return"))
