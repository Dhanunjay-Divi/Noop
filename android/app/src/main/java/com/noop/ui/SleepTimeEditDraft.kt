...
internal data class SleepTimeEditDraft(
    ...
    /** Preserve the complete user-selected wake instant, including its calendar date. */
    fun withWakeCandidate(candidateWakeTs: Long): SleepTimeEditDraft = copy(endTs = candidateWakeTs)
