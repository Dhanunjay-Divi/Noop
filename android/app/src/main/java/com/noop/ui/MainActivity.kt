...
object NoopPrefs {
    ...
    /** #836, the raw scoring-input fingerprint ("count:maxTs") the last COMPLETED idle rescore scored
     *  against. The 15-min backstop skips when it is unchanged; any score-bearing stream insert/delete
