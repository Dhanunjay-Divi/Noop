...
/// `TodayView.provenanceDisplayLabel` (strap -> "Imported", Health Connect -> "Health Connect", Apple Health ->
...
final class VitalReadingsTableTests: XCTestCase {
    ...
    func testSourceLabelsResolvePerSample() {
        ...
        XCTAssertEqual(rows.map(\.source), ["Apple Health", "Health Connect", "Imported"])
    }
