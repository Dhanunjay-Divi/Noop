...
committing and pushing are left to the repository's normal Git workflow, so the working tree
...
API="https://api.github.com/repos/Dhanunjay-Divi/Noop"
...
open_issues=search_count("repo:Dhanunjay-Divi/Noop is:issue is:open")
resolved=search_count("repo:Dhanunjay-Divi/Noop is:issue is:closed")
