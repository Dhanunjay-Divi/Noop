...
locales.each do |locale, directory|
  path = File.join(repo_root, "android/app/src/main/res", directory, "appwide.xml")
  ...
  File.write(
    ...
    [
      ...
      "<resources>",
      "    <!-- Generated by Tools/AppWideLocalization/generate.rb. -->",
      *lines,
      "</resources>",
      ""
    ].join("\n")
...
catalog = catalog.lines.reject { |line| line.match?(/^\s+"appwide\.[^"]+":/) }.join
marker = "\n  },\n  \"version\":"
